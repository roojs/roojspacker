/* roojspacker.h generated by valac 0.32.0, the Vala compiler, do not modify */


#ifndef __ROOJSPACKER_H__
#define __ROOJSPACKER_H__
...
gchar* jsdoc_packer_pack (JSDOCPacker* self);
